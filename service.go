...
//define the interface to interact with key-value store
...
func createService(addr string, store Store) *Service {
	return &Service{
		addr:  addr,
		store: store,
	}
...
//getter for the address of a service
...
func (s *Service) handleKeyRequest(w http.ResponseWriter, r *http.Request) {
	...
	case "GET":
		...
		v, err := s.store.Get(k) //grab the value
